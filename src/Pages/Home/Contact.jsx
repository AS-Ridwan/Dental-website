            ...
            <div className="p-2 w-1/2">
              <div className="relative">
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full  rounded border border-gray-300 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out bg-white"
                />
              </div>
            </div>
            <div className="p-2 w-1/2">
